...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::get('/admin/orders/index', 'App\Http\Controllers\OrderController@index')->name("order.index");
});
...
Route::get('/orders/save', 'App\Http\Controllers\OrderController@save')->name("order.save");
Route::get('/orders/create', 'App\Http\Controllers\OrderController@create')->name("order.create");
Route::post('/orders/add/{id}', 'App\Http\Controllers\OrderController@add')->name("order.add");
